                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                            ...
                            {!! Form::text('thumbnail', $news->thumbnail, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                        ...
                        <div class="form-group @if($errors->has('short_describe')) has-error @endif">
                            ...
                            {!! Form::text('short_describe', $news->short_describe, ['class' => 'form-control', 'placeholder' => 'Sub Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('post_content')) has-error @endif">
                            {!! Form::label('Details') !!}
                            {!! Form::textarea('post_content', $news->post_content, ['class' => 'form-control', 'placeholder' => 'Details']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="number" name="position" id="position" value="{{ old('position', $news->position) }}" step="1">
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            ...
            }).val({!! json_encode($news->categories()->allRelatedIds()) !!}).trigger('change');
        });
    </script>
@endsection