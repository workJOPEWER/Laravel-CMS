                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                            ...
                            {!! Form::text('thumbnail', $article->thumbnail, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                        ...
                        <div class="form-group @if($errors->has('short_describe')) has-error @endif">
                            ...
                            {!! Form::text('short_describe', $article->short_describe, ['class' => 'form-control', 'placeholder' => 'Sub Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('post_content')) has-error @endif">
                            {!! Form::label('Content') !!}
                            {!! Form::textarea('post_content', $article->post_content, ['class' => 'form-control', 'placeholder' => 'Content']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="number" name="position" id="position" value="{{ old('position', $article->position) }}" step="1">
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            ...
            }).val({!! json_encode($article->categories()->allRelatedIds()) !!}).trigger('change');
        });
    </script>
@endsection
